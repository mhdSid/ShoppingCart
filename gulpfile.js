...
(function() {
  ...
  gulp.src('')
     ...
     */
    gulp.task("js-injector", ['ts-compiler'], function() {
        return gulp.src(config.index)
            .pipe(lazy.inject(gulp.src(config.jsPath, {
                read: false
            })))
            .pipe(gulp.dest(""));
    });
    ...
    gulp.task("css-injector", ['auto-prefixer'], function() {
        return gulp.src(config.index)
            .pipe(lazy.inject(gulp.src(config.environment + "/_public/styles/main.css", {
                read: false
            })))
            .pipe(gulp.dest(""));
    });
...
*/
    ...
    function useRefBuild() {
        ...
        gulp.src(config.index)
            .pipe(lazy.inject(gulp.src(config.build + "templates.js", {
                read: false
            }), {
